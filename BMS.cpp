...
void Loginmember()
{
	...
	if (!qstate) {
		...
		if (res) {
			if (mysql_num_rows(res) == 1) {
				row = mysql_fetch_row(res);
				role = row[9]; // Assuming Level is stored as a string in the database
				name = row[3];
				userID = row[0];
...
cashier :
	...
	cout << setw(99) << "******************************************************************************" << endl;
	cout << setw(99) << "*                                                                            *" << endl;
	cout << setw(99) << "*                              MAIN MENU - CASHIER                           *" << endl;
	cout << setw(99) << "*                                                                            *" << endl;
	cout << setw(99) << "******************************************************************************" << endl;
	cout << "\n\n\t\tLogged in as : " << name << endl << endl;
	cout << setw(56) << "1. Manage Order And Receipt List\n\n";
	cout << setw(53) << "2. Manage Report Sales\n\n";
	...
	case 1:
		...
		cout << setw(99) << "******************************************************************************" << endl;
		cout << setw(99) << "*                                                                            *" << endl;
		cout << setw(99) << "*                         MENU - MANAGE ORDER AND RECEIPT LIST               *" << endl;
		cout << setw(99) << "*                                                                            *" << endl;
		cout << setw(99) << "******************************************************************************" << "\n\n" << endl;
		cout << setw(57) << "1. Display Orders and Generete Receipt\n\n";
		cout << setw(48) << "2. Back\n\n\n";
		cout << setw(50) << "Please Enter Your Choice : ";
		cin >> choose;
	...
	case 2:
		...
		cout << setw(99) << "******************************************************************************" << endl;
		cout << setw(99) << "*                                                                            *" << endl;
		cout << setw(99) << "*                         MENU - MANAGE REPORT SALE                          *" << endl;
		cout << setw(99) << "*                                                                            *" << endl;
		cout << setw(99) << "******************************************************************************" << "\n\n" << endl;
		cout << setw(57) << "1. Display Report Sale\n\n";
		cout << setw(48) << "2. Back\n\n\n";
		cout << setw(50) << "Please Enter Your Choice : ";
		cin >> choose;
